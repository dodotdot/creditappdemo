...
**Jawaban: tidak ada, karena belum ada hit api asli**
...
1.browser-front end-back end - database 2. karena menggunakan mock api yang kemnbalikan respon yang sudah dibuat dalam keadaan berhasil jadi tidak terlihat bug nya 3. scoreWithMock menggunakan data mock/data dummy, sedangkan callUatBackend melakukan call ke API Backend menggunakan method fetch dari JavaScript dan datanya bersifat real
